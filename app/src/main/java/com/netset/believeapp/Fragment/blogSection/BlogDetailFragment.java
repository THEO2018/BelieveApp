...
public class BlogDetailFragment extends BaseFragment implements ApiResponse {
    ...
    @BindView(R.id.mainBlogDetailsId)
    ConstraintLayout mainBlogDetailsId;
    ...
    public void CallApi() {
        ...
        baseActivity.apiHitAndHandle.makeApiCall(getBlogDetail, this, baseActivity);
    ...
    public void onSuccess(Call call, Object object) {
        ...
        mainBlogDetailsId.setVisibility(View.VISIBLE);
        ...
        blogTextTV.setText(result.getData().getBlog());
