...
public class PrayerRequestFragment extends BaseFragment implements ApiResponse {
    ...
    public void TrendingApi(){
        ...
        baseActivity.apiHitAndHandle.makeApiCall(GetTrendPrayerList, this, true, baseActivity);
    }
    ...
    public void LiveApi(){
        ...
        baseActivity.apiHitAndHandle.makeApiCall(GetLivePrayerList, this, true, baseActivity);
    }
