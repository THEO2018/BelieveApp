...
public class OtherClassifiedFrag extends BaseFragment implements ApiResponse {
    ...
    OtherClassifiedAdapter jobsAdapter;
    ...
    public void onSuccess(Call call, Object object) {
        ...
        jobsAdapter = new OtherClassifiedAdapter(baseActivity, result.data);
        ...
        jobsList_RV.addOnItemTouchListener(new RecyclerTouchListener(baseActivity, jobsList_RV,
                new RecyclerTouchListener.ClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        ...
                        baseActivity.navigateFragmentTransaction_ARG(R.id.homeContainer, new OtherDescriptionFrag(),args);
                    }
