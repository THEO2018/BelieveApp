...
public class GroupProfilePageFragment extends BaseFragment implements ApiResponse {
    ...
    public void CallApi(){
        ...
        if(b != null) {
            ...
            baseActivity.apiHitAndHandle.makeApiCall(about, this,false, baseActivity);
        ...
        switch (view.getId()) {
            case R.id.joinGrp_BTN:
                ...
                if(b != null) {
                    ...
                    baseActivity.apiHitAndHandle.makeApiCall(Join, this,true, baseActivity);
    ...
    public void onSuccess(Call call, Object object) {
        ...
        try {
            if(call == about) {
                ...
                ((HomeActivity) requireActivity()).setToolbarTitle(groupTitle, true, false, false, null);
