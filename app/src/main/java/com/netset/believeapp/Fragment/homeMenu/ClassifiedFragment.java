...
import com.netset.believeapp.Fragment.classifiedSection.OtherClassifiedFrag;
...
public class ClassifiedFragment extends BaseFragment implements ApiResponse {
    ...
    public void CallApi() {
        ...
        baseActivity.apiHitAndHandle.makeApiCall(GetCategories, this,false, baseActivity);
        ...
        if( categoryList.size() > 0){
            ...
            if (position == 0) {
                if (categoryList.get(0).getCatName().equals("Birth News")) {
                    ...
                    baseActivity.navigateFragmentNoBackStack_ARG(R.id.tabSelection_Container, new OtherClassifiedFrag(), args);
                }
            } else if (position == 1) {
