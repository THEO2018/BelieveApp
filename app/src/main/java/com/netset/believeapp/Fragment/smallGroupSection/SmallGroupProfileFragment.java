...
public class SmallGroupProfileFragment extends BaseFragment implements ApiResponse {
    ...
    @BindView(R.id.mainLayBg)
    ConstraintLayout mainLayBg;
   ...
   /* ApiInterface apiInterface;
        ...
        switch (view.getId()) {
            case R.id.joinGrp_BTN:
                ...
                if(b!=null) {
                    ...
                    baseActivity.apiHitAndHandle.makeApiCall(JoinGroup, this, baseActivity);
                }
                break;
    ...
    private void viewAllWEdListSpannable() {
        ...
        if(b!=null){
            ...
            baseActivity.apiHitAndHandle.makeApiCall(GetGroupDetail, this, baseActivity);
        }
    ...
    public void onSuccess(Call call, Object object) {
        mainLayBg.setVisibility(View.VISIBLE);
