...
public class ShowAboutDescriptionFragment extends BaseFragment implements ApiResponse {
    ...
    TextView catNameTV;
    @BindView(R.id.presntationLayMain)
    LinearLayout presntationLayMain;
    ...
    public void CallApi() {
        ...
        baseActivity.apiHitAndHandle.makeApiCall(getAboutUsDetail, this, baseActivity);
    ...
    public void onSuccess(Call call, Object object) {
        presntationLayMain.setVisibility(View.VISIBLE);
