...
public class ShowPollFragment extends BaseFragment implements ApiResponse {
    ...
    @BindView(R.id.mainLinPole)
    LinearLayout mainLinPole;
    ...
    public void GetPollDetail() {
        ...
        baseActivity.apiHitAndHandle.makeApiCall(GetPolldetail, this, baseActivity);
    }
    ...
    public void onSuccess(Call call, Object object) {
        mainLinPole.setVisibility(View.VISIBLE);
                ...
                optionList_RV.addOnItemTouchListener(new RecyclerTouchListener(baseActivity, optionList_RV, new RecyclerTouchListener.ClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        ...
                        if (!result.data.settingMultipleChoice) {
                            ...
                            baseActivity.apiHitAndHandle.makeApiCall(AddVote, ShowPollFragment.this, false, baseActivity);
