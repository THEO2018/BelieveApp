...
public class NotificationFragment extends BaseFragment implements ApiResponse, GroupAdapter.RefreshCallBack {
   ...
   /* @BindView(R.id.viewAll_TV)
    ...
    public void CallApi() {
        ...
        baseActivity.apiHitAndHandle.makeApiCall(getGroups, this, baseActivity);
    }
        ...
        if(call == getGroups) {
            ...
            notifSwitch.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    baseActivity.apiHitAndHandle.makeApiCall(SetNotifySound, NotificationFragment.this,false, baseActivity);
                }
            });
