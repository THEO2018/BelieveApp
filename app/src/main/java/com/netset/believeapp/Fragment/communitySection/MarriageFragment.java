...
//----------------wedding list adapter---------------
        ...
        weddingListAdapter = new WeddingListAdapter(baseActivity, result.getData().getWeddingLists(), false, position -> {
            ...
            if (uri.toString().startsWith("http://")||uri.toString().startsWith("https://")){
                ...
                Bundle args = new Bundle();
                args.putString("newslink","http://"+result.getData().getWeddingLists().get(position).getUrlOnlineSite());
                args.putString("newsname","Wedding");
                baseActivity.navigateFragmentTransaction_ARG(R.id.homeContainer, new WebViewFragment(),args);
            }
        });
