    ...
    private void validateLoginData() {
        ...
        if (isValidText(email) && isValidText(password)) {
            if (checkValidationsForEmailMobile(email) || checkValidationsForEmailMobile(email)) {
                ...
                baseActivity.apiHitAndHandle.makeApiCall(Login, this, baseActivity);
...
//                            url = "https://graph.facebook.com/" + id + "/picture?type=large";
                           ...
                           /* if(!url.equals("") || url!= null){
                            ...
                            signUp =  baseActivity.apiInterface.Signup(map);
                            baseActivity.apiHitAndHandle.makeApiCall(signUp, LoginFragment.this,true, baseActivity);
    ...
    private void hitApi(Call<JsonObject> call,HashMap<String, String> map) {
        ...
        baseActivity.apiHitAndHandle.makeApiCall(call, LoginFragment.this,true, baseActivity);
    }
...
//                            }
                            signUp2 = baseActivity.apiInterface.Signup(map);
                            baseActivity.apiHitAndHandle.makeApiCall(signUp2,LoginFragment.this,true, baseActivity);
    ...
    public void onSuccess(Call call, Object object) {
        ...
        try {
            ...
            if(call == Login){
                ...
                PrefUtils.INSTANCE.setSaveValue(requireContext(),"user_id",user_id);
