...
public class MyProfileFragment extends BaseFragment implements ApiResponse {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        }else if (b.getString("From").equals("fullpost")){
            ((ShowFullPostActivity) getActivity()).setToolbarTitle("Profile", true, false);
        }
        else{
    ...
    public void GetProfileApi(){
        ...
        baseActivity.apiHitAndHandle.makeApiCall(GetProfile, this, baseActivity);
    }
...
//        PrefUtils.INSTANCE.setSaveValue(requireContext(),"user_id",result.getData().getId());
//        CommonDialogs.getSquareImage(getActivity(),result.getData().getProfileImage(),coverImageIV);
        ...
        CommonConst.Companion.loadGlide(requireContext(),result.getData().getProfileImage(),R.drawable.empty).into(coverImageIV);
      ...
      if(result.getData().getPhoneNumber().equals("")){
        ...
        if (b.getString("From").equals("fullpost")){
            ((ShowFullPostActivity) getActivity()).setToolbarTitle(result.getData().getFirstName().trim()+" "+result.getData().getLastName().trim(), true, false);
        }
        else{
