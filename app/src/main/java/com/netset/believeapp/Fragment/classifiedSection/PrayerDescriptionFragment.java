...
public class PrayerDescriptionFragment extends BaseFragment implements ApiResponse, CommentAdapter.OnItemClickListener {
    ...
    @BindView(R.id.prayerMain)
    RelativeLayout prayerMain;
...
//            CallApi();
    ...
    public void CallApi() {
        ...
        baseActivity.apiHitAndHandle.makeApiCall(GetPrayerDetail, this, baseActivity);
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.send_IV:
                ...
                if (commentET.getText().toString().trim().equals("")) {
                    ...
                    baseActivity.apiHitAndHandle.makeApiCall(AddComment, this, false, baseActivity);
                }
                break;
            case R.id.pray_BT:
                ...
                if (result.data.myPrayer.equals(true)) {
                    ...
                    baseActivity.apiHitAndHandle.makeApiCall(AnswerPrayer, this, false, baseActivity);
                    ...
                    baseActivity.apiHitAndHandle.makeApiCall(PrayForother, this, false, baseActivity);
                }
    ...
    public void onSuccess(Call call, Object object) {
        ...
        if (call == GetPrayerDetail) {
            ...
            prayerMain.setVisibility(View.VISIBLE);
            ((HomeActivity) getActivity()).setToolbarTitle(result.data.title, true, false, false, null);
            prayertitleTV.setText(result.data.title);
            timeTV.setText(CommonConst.Companion.utcToLocalDate(result.data.createdDate + " " + result.data.createdTime));
            ...
            commentAdapter = new CommentAdapter(baseActivity, result.data.comments, false, "pray",this);
            ...
            commentList_RV.addOnItemTouchListener(new RecyclerTouchListener(baseActivity, commentList_RV,
                    new RecyclerTouchListener.ClickListener() {
                        ...
                        public void onClick(View view, int position) {
                            ...
                            Fragment fragmentById = baseActivity.getSupportFragmentManager().findFragmentById(R.id.homeContainer);

                            if (fragmentById instanceof SelectedUserProfileFragment){
                                return;
                            }
