...
//                    }
        ...
        holder.profile_image_IV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(model.getOther_id().equals(GeneralValues.get_user_id(mContext))){
                    ...
                    ((BaseActivity)mContext).navigateFragmentTransaction_ARG(R.id.editViewContainer, new MyProfileFragment(),args);
                }else{
                    Bundle args = new Bundle();
        ...
        BetterLinkMovementMethod
                .linkify(Linkify.ALL, holder.cmnt_Text_TV)
                .setOnLinkClickListener((textView, url) -> {
                    if (url.contains("youtube") || url.contains("youtu.be")) {
                        ...
                        ((BaseActivity)mContext).navigateFragmentTransaction_ARG(R.id.editViewContainer, new WebViewFragment(),args);
                    }
