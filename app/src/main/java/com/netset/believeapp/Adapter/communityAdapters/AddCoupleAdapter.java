...
//        List<AllUsersModel.Datum> sortedList = grpList.stream().sorted().collect(Collectors.toList());
//        this.grpList=sortedList;
        grpList.sort((o1, o2) ->o1.getFirstName().substring(0, 1).toUpperCase().compareTo(o2.getFirstName().substring(0, 1).toUpperCase()) );
