...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            editNotes = view.findViewById(R.id.edit_note);
        }
    }

    public NotesAdapter(Context mContext, List<NotesListModel.Datum> notesList,NotesClickListener listener) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.editNotes.setOnClickListener(v -> {
          listener.onClickNote(notesList.get(position).getTitle(),notesList.get(position).getDescription(),notesList.get(position).getId());
        });
    }
    ...
    public interface NotesClickListener{
        void onClickNote(String title,String desc,String id);
    }
