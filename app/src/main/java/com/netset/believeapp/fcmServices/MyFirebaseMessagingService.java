        ...
        try {
            ...
            if(type.equals("liked") || type.equals("commented") || type.equals("posted")){
                ...
                if (mPreferencees.getString("couplebool", "").equals("true")) {
                        startActivity(new Intent(this, CouplesActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));

                }
                else {
                    intent = new Intent(this, CouplesActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    sendNotification();
                }
            }
